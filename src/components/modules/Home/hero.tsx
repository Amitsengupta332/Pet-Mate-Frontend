...
import { Search, MapPin, PawPrint, Star, ShieldCheck, Calendar } from "lucide-react";
    ...
    <section className="relative bg-gradient-to-b from-orange-50/50 via-background to-background py-10 lg:py-16 overflow-hidden">
      <div className="container px-4 md:px-8 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          {/* Left Column: Text & Quick Search Widget */}
          <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground leading-[1.15]">
              Loving Care for Your <span className="text-orange-500">Furry Friends</span> While You’re Away.
            </h1>

            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto lg:mx-0">
              Book trusted local pet sitters, dog walkers, and boarding facilities in seconds. Your pet deserves the best care possible.
            </p>

            {/* Quick Search Widget */}
            <div className="mt-2 p-3 sm:p-4 bg-card rounded-2xl border shadow-xl flex flex-col md:flex-row gap-3 items-center">
              <div className="flex items-center gap-2.5 px-3 py-2 border-b md:border-b-0 md:border-r border-border w-full md:w-1/3">
              ...
              <div className="w-full md:w-1/3">
                <Link href="/sitters">
                  <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-5 rounded-xl flex items-center justify-center gap-2 shadow-md hover:shadow-orange-500/20 transition-all">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 pt-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground leading-tight">Happy<br/>Pets Served</span>
              </div>
          ...
          {/* Right Column: 3-Image Shadcn Carousel */}
                      ...
                      <CarouselItem key={slide.id}>
                        <div className="relative h-[380px] sm:h-[450px] rounded-3xl overflow-hidden border-4 border-background shadow-2xl">
                          ...
                          <div className="absolute bottom-6 left-6 bg-card/90 backdrop-blur-md p-3.5 rounded-2xl shadow-xl border border-border flex items-center gap-3">
                            <div className={`h-10 w-10 rounded-full flex items-center justify-center font-bold ${slide.badgeBg}`}>
                              <IconComponent className="h-5 w-5" />
                            </div>
                            <div>
                              <p className="text-xs font-semibold text-foreground">{slide.badgeTitle}</p>
                              <p className="text-[10px] text-muted-foreground">{slide.badgeSub}</p>
                            </div>
                          </div>
                        </div>
                      </CarouselItem>
