...
const petSchema = z.object({
  ...
  age: z.string().min(1, "Age is required (e.g. 2 years)"),
        ...
        <div className="flex items-center gap-3 mb-6 pb-6 border-b border-border">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Provide details about your furry family member.
            </p>
          </div>
        </div>
                ...
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Textarea
                      ...
                      id="pet-notes"
                      rows={3}
                      placeholder="Any habits, allergies, or special requirements sitters should know..."
          ...
          >
            {isLoading ? (
              <>
                ...
                <span>Saving Pet...</span>
              </>
            ) : (
              <span>Add Pet to Profile</span>
            )}
          </Button>
        </form>
      </div>
